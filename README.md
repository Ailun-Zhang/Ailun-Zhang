...
Theoretical cosmology | Ultralight dark matter (ULDM) | Black hole dynamics
...
- Eigenfunction / mode-based decompositions for Schrödinger–Poisson solitons

General interests in high-energy theory and theoretical cosmology:
- Quantum field theory in curved spacetime
- Early-universe physics and cosmological correlations
...
- **PyUL_SK**: a research-focused update of ULDM soliton and black hole dynamics workflows, **forked from** `Sifyrena/PyUL_NBody` and extended for my Honours project  
  Repo: https://github.com/Ailun-Zhang/PyUL_SK
...
## Contact
- Email: Alan.Zhang3@outlook.com
- GitHub: https://github.com/Ailun-Zhang
